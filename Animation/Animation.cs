...
namespace Animation_Enemys
{
    public class Animation
    {
        static public void Training()
        {
            ...
            Console.SetCursorPosition(103, 39);
            Console.Write("(escape)");
        }
